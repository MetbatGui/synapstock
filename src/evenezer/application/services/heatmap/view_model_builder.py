...
from evenezer.domain.heatmap.models import Theme, ThemeGroup
from evenezer.presentation.web.routes.heatmap.view_models import HeatmapViewModel, TreemapNode
...
class HeatmapViewModelBuilder:
    ...
    def _validate_parent_child_sums(nodes: List[TreemapNode], tolerance: float = 0.01):
        ...
        if mismatches:
            # evenezer 로깅을 지원하기 위해 지연/동적 로깅 시도
            try:
                import logging
