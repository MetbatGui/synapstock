...
from evenezer.presentation.web.routes.heatmap.view_models import HeatmapViewModel
...
class HeatmapVisualizer:
    ...
    def create_treemap_from_viewmodel(
        ...
        Args:
            ...
            initial_depth (int): 초기 표시 깊이 (기본값: 3 = Root + Group + Theme).
                클릭 시 drill-down됩니다. Defaults to 3.
        """
        custom_colorscale = [
            [0.0, 'blue'],
            [0.5, '#444444'],
        ...
        if "EVENEZER_HOST" not in os.environ:
            try:
