...
export const convertibleBondView = {
            ...
            <div class="stats-detail-container animate-fade-in">
                ...
                <div class="stats-info-footer">
                    <div class="footer-left">
                         ...
                         ${item.parent_rcp_no ? `<br/><i class="fas fa-link"></i> 상위공시: <a href="#" onclick="convertibleBondView.jumpToHistory('${item.parent_rcp_no}'); return false;" style="color:var(--accent-blue); text-decoration:underline;">${item.parent_rcp_no}</a>` : ''}
                    </div>
    ...
    jumpToHistory: function (rcpNo) {
        ...
        setTimeout(() => {
            targetRow = document.querySelector(`.cb-row[data-rcp-no="${rcpNo}"]`);
            if (targetRow) {
