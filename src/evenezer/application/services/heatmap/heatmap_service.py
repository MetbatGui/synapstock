...
from evenezer.domain.heatmap.models import Stock, Theme, ThemeGroup, Heatmap
from evenezer.domain.heatmap.value_objects import MarketCap, ChangeRatio
from evenezer.domain.heatmap.services import ThemeStatisticsService, StockValidator
from evenezer.domain.heatmap.theme_config import THEME_HIERARCHY, THEME_RENAME
from evenezer.domain.heatmap.ports import ThemeDataLoaderPort, KrxDataPort
...
class HeatmapService:
    ...
    def __init__(
        self, 
        loader: Optional[ThemeDataLoaderPort] = None,
        krx_repo: Optional[KrxDataPort] = None,
        stock_validator: Optional[StockValidator] = None
    ):
        if krx_repo:
